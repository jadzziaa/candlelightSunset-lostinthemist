...
local bloodLife = {
	...
	CmpTestTubeWithInfectedBlood = { Target = "CmpTestTubeWithTaintedBlood", Time = 1440 },
};

-- Vaciine effectiveness
local vaccineEffect = {
	CmpSyringeWithTestVaccine = { Min = 0.50, Max = 0.65, CureChance = 0, InfectChance = 97, Time = 0, Strength = 0, AlbuminMin = 2, AlbuminDelta = 3, Recess = 0, },
	CmpSyringeWithTestVaccineV2 = { Min = 0.43, Max = 0.68, CureChance = 0, InfectChance = 95, Time = 0, Strength = 0, AlbuminMin = 3, AlbuminDelta = 4, Recess = 0, },
	CmpSyringeWithTestVaccineV3 = { Min = 0.30, Max = 0.70, CureChance = 0, InfectChance = 20, Time = 150, Strength = 20, AlbuminMin = 5, AlbuminDelta = 5, Recess = 1, },
	CmpSyringeWithQualityVaccine = { Min = 0.20, Max = 0.80, CureChance = 1, InfectChance = 2, Time = 336, Strength = 50, AlbuminMin = 8, AlbuminDelta = 6, Recess = 2, },
	CmpSyringeWithCure = { Min = -1, Max = 0.80, CureChance = 90, InfectChance = 0, Time = 0, Strength = 0, AlbuminMin = 0, AlbuminDelta = 0, Recess = 0, },
	CmpSyringeWithVirus = { Min = -1, Max = 0.76, CureChance = 0, InfectChance = 100, Time = 0, Strength = 0, AlbuminMin = 0, AlbuminDelta = 0, Recess = 0, },

	CmpSyringeReusableWithTestVaccine = { Min = 0.50, Max = 0.65, CureChance = 0, InfectChance = 97, Time = 0, Strength = 0, AlbuminMin = 2, AlbuminDelta = 3, Recess = 0, },
	CmpSyringeReusableWithTestVaccineV2 = { Min = 0.43, Max = 0.68, CureChance = 0, InfectChance = 95, Time = 0, Strength = 0, AlbuminMin = 3, AlbuminDelta = 4, Recess = 0, },
	CmpSyringeReusableWithTestVaccineV3 = { Min = 0.30, Max = 0.70, CureChance = 0, InfectChance = 20, Time = 150, Strength = 20, AlbuminMin = 5, AlbuminDelta = 5, Recess = 1, },
	CmpSyringeReusableWithQualityVaccine = { Min = 0.20, Max = 0.80, CureChance = 1, InfectChance = 2, Time = 336, Strength = 50, AlbuminMin = 8, AlbuminDelta = 6, Recess = 2, },
	CmpSyringeReusableWithCure = { Min = -1, Max = 0.80, CureChance = 90, InfectChance = 0, Time = 0, Strength = 0, AlbuminMin = 0, AlbuminDelta = 0, Recess = 0, },
	CmpSyringeReusableWithVirus = { Min = -1, Max = 0.76, CureChance = 0, InfectChance = 100, Time = 0, Strength = 0, AlbuminMin = 0, AlbuminDelta = 0, Recess = 0, },
...
function LabRecipes_PrintTestInfo(player, obj)
	...
	if player then
		...
		print(string.format("VaccineResearch level: %d - %d ( x %1.1f )",player:getPerkLevel(Perks.VaccineResearch),xp:getXP(Perks.VaccineResearch),xp:getMultiplier(Perks.VaccineResearch)));
...
-- Inject a virus
function LabRecipes_DoInjectionVirus(player, vaccine)
	local body = player:getBodyDamage();
	local pMod = player:getModData();
	pMod.AlbuminDoses = 0;
	pMod.VaccineRecess = 0;
...
--Test Vaccine V1 Tests
function LabRecipes_CreateVaccineTestResult1(items, result, player)
	for i = 0, items:size()-1 do
		local item = items:get(i);
		if item:getType() == "CmpSyringeWithBlood" then
			if not(item:getModData().IsInfected) then 
				player:getInventory():AddItem("LabItems.LabVaccineTestUnsuccessful");
				player:getInventory():AddItem("LabItems.LabSyringeUsed");
			elseif VaccineTestSC > ZombRand(100) then
				player:getInventory():AddItem("LabItems.LabVaccineTestSuccessful1");
				player:getInventory():AddItem("LabItems.LabSyringeUsed");
			else
				player:getInventory():AddItem("LabItems.LabVaccineTestUnsuccessful");
				player:getInventory():AddItem("LabItems.LabSyringeUsed");
...
--Test Vaccine V1 Tests Reusable
function LabRecipes_CreateVaccineTestResult1Two(items, result, player)
	for i = 0, items:size()-1 do
		local item = items:get(i);
		if item:getType() == "CmpSyringeReusableWithBlood" then
			if not(item:getModData().IsInfected) then 
				player:getInventory():AddItem("LabItems.LabVaccineTestUnsuccessful");
				player:getInventory():AddItem("LabItems.LabSyringeReusableUsed");
			elseif VaccineTestSC > ZombRand(100) then
				player:getInventory():AddItem("LabItems.LabVaccineTestSuccessful1");
				player:getInventory():AddItem("LabItems.LabSyringeReusableUsed");
			else
...
--Test Vaccine V2 Tests
function LabRecipes_CreateVaccineTestResult2(items, result, player)
	for i = 0, items:size()-1 do
		local item = items:get(i);
		if item:getType() == "CmpSyringeWithBlood" then
			if not(item:getModData().IsInfected) then 
				player:getInventory():AddItem("LabItems.LabVaccineTestUnsuccessful");
				player:getInventory():AddItem("LabItems.LabSyringeUsed");
			elseif VaccineTestSC > ZombRand(150) then
				player:getInventory():AddItem("LabItems.LabVaccineTestSuccessful2");
				player:getInventory():AddItem("LabItems.LabSyringeUsed");
			else
				player:getInventory():AddItem("LabItems.LabVaccineTestUnsuccessful");
				player:getInventory():AddItem("LabItems.LabSyringeUsed");
...
--Test Vaccine V2 Tests Reusable
function LabRecipes_CreateVaccineTestResult2Two(items, result, player)
	for i = 0, items:size()-1 do
		local item = items:get(i);
		if item:getType() == "CmpSyringeReusableWithBlood" then
			if not(item:getModData().IsInfected) then 
...
--Test Vaccine V3 Tests
function LabRecipes_CreateVaccineTestResult3(items, result, player)
	for i = 0, items:size()-1 do
		local item = items:get(i);
		if item:getType() == "CmpSyringeWithBlood" then
			if not(item:getModData().IsInfected) then 
				player:getInventory():AddItem("LabItems.LabVaccineTestUnsuccessful");
				player:getInventory():AddItem("LabItems.LabSyringeUsed");
			elseif VaccineTestSC > ZombRand(200) then
				player:getInventory():AddItem("LabItems.LabVaccineTestSuccessful3");
				player:getInventory():AddItem("LabItems.LabSyringeUsed");
			else
				player:getInventory():AddItem("LabItems.LabVaccineTestUnsuccessful");
				player:getInventory():AddItem("LabItems.LabSyringeUsed");
...
--Test Vaccine V3 Tests Reusable
function LabRecipes_CreateVaccineTestResult3Two(items, result, player)
	for i = 0, items:size()-1 do
		local item = items:get(i);
		if item:getType() == "CmpSyringeReusableWithBlood" then
			if not(item:getModData().IsInfected) then 
...
-- Select and inject the virus
function LabRecipes_InjectVirus(items, result, player)
	for i = 0, items:size()-1 do
		local obj = items:get(i);
		if vaccineEffect[obj:getType()] then
			LabRecipes_DoInjectionVirus(player, vaccineEffect[obj:getType()]);
			return;
		end--if
	end--for
	LabRecipes_PrintTestInfo(player,result);
...
function LabRecipes_AddCharcoal(items, result, player)
	local inv = player:getInventory();
	inv:AddItem("Base.Charcoal");
end--function

function LabRecipes_RemoveCarBattery(items, result, player)
	local inv = player:getInventory();
	for i = 0, items:size()-1 do
		if string.find(items:get(i):getType(),"CarBattery1") then
			inv:Remove('CarBattery1');
		elseif string.find(items:get(i):getType(),"CarBattery2") then
			inv:Remove('CarBattery2');
		elseif string.find(items:get(i):getType(),"CarBattery3") then
			inv:Remove('CarBattery3');
		end--if
	end--for
end--function

-- Adds more items for centerifuge Reusable
function LabRecipes_AddMoreBloodComponents(items, result, player)
	for i = 0, items:size()-1 do
		if string.find(items:get(i):getType(),"CmpSyringeWith") then
			player:getInventory():AddItem("LabItems.LabSyringeUsed");
		end--if
	end--for
...
-- Adds more items for centerifuge Reusable
function LabRecipes_AddMoreBloodComponentsTwo(items, result, player)
	for i = 0, items:size()-1 do
		if string.find(items:get(i):getType(),"CmpSyringeReusableWith") then
			player:getInventory():AddItem("LabItems.LabSyringeReusableUsed");
		end--if
	end--for
	player:getInventory():AddItem("LabItems.CmpFlaskWithBloodPlasma");
...
function LabRecipes_GiveXP_VaccineResearch_1(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 2);
end--function

function LabRecipes_GiveXP_VaccineResearch_2(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 4);
end--function

function LabRecipes_GiveXP_VaccineResearch_3(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 6);
end--function

function LabRecipes_GiveXP_VaccineResearch_4(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 8);
end--function

function LabRecipes_GiveXP_VaccineResearch_5(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 10);
end--function

function LabRecipes_GiveXP_VaccineResearch_6(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 12);
end--function

function LabRecipes_GiveXP_VaccineResearch_7(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 14);
end--function

function LabRecipes_GiveXP_VaccineResearch_8(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 16);
end--function

function LabRecipes_GiveXP_VaccineResearch_9(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 18);
end--function

function LabRecipes_GiveXP_VaccineResearch_10(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 20);
end--function

function LabRecipes_GiveXP_VaccineResearch_15(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 30);
end--function

function LabRecipes_GiveXP_VaccineResearch_20(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 40);
end--function

function LabRecipes_GiveXP_VaccineResearch_25(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 50);
end--function

function LabRecipes_GiveXP_VaccineResearch_30(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 60);
end--function

function LabRecipes_GiveXP_VaccineResearch_35(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 70);
end--function

function LabRecipes_GiveXP_VaccineResearch_50(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 100);
end--function

function LabRecipes_GiveXP_VaccineResearch_85(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 170);
end--function

function LabRecipes_GiveXP_VaccineResearch_120(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 240);
end--function

function LabRecipes_GiveXP_VaccineResearch_150(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 300);
end--function
...
function LabRecipes_GiveXP_CombinedFARS_1(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 4);
	player:getXp():AddXP(Perks.Doctor, 1);
end--function

function LabRecipes_GiveXP_CombinedFARS_2(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 4);
	player:getXp():AddXP(Perks.Doctor, 2);
end--function

function LabRecipes_GiveXP_CombinedFARS_3(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.VaccineResearch, 4);
	player:getXp():AddXP(Perks.Doctor, 3);
end--function
...
function LabRecipes_GiveXP_MetalWorking_2(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.MetalWelding, 4);
end--function

function LabRecipes_GiveXP_MetalWorking_3(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.MetalWelding, 6);
end--function

function LabRecipes_GiveXP_MetalWorking_5(recipe, ingredients, result, player)
	player:getXp():AddXP(Perks.MetalWelding, 10);
end--function

function LabRecipes_GiveXP_MetalWorking_10(recipe, ingredients, result, player)
...
function LabRecipes_CreateCorpseAutopsyTooltip(option, inventory, notFresh, notZombie, notOrgans)
	...
	local ok = true;
	ok = LabRecipes_CreateCheckTooltip(option, inventory, "Base", {"Hat_DustMask","Hat_SurgicalMask_Blue", "Hat_SurgicalMask_Green","Hat_BandanaMaskRed","Hat_BandanaMaskDesert","Hat_GasMask","GasMaskCEDA"}, 1, true) and ok;
	...
	ok = LabRecipes_CreateCheckTooltip(option, inventory, "Base", {"JournalOfResearch"}, 1) and ok;
