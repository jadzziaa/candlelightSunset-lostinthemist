...
table.insert(ProceduralDistributions["list"]["KitchenDryFood"].items, NonPerishableSpawnChance * 0.22);
...
table.insert(ProceduralDistributions["list"]["GigamartDryGoods"].items, NonPerishableSpawnChance * 0.22);
...
table.insert(ProceduralDistributions["list"]["GigamartCannedFood"].items, NonPerishableSpawnChance * 0.22);
...
table.insert(ProceduralDistributions["list"]["GigamartCandy"].items, NonPerishableSpawnChance * 0.2);
...
table.insert(ProceduralDistributions["list"]["BakeryMisc"].items, NonPerishableSpawnChance * 0.3);
