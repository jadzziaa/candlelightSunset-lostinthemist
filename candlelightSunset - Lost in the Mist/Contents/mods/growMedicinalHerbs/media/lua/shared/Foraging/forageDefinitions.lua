...
local function doWildCropSpawn(_character, _inventory, _itemDef, _items)
	local seedTable = {
		...
		["Base.BlackSage"] = "GMH.BlackSageseed",
		["Base.Plantain"] = "GMH.Plantainseed",
		["Base.Comfrey"] = "GMH.Comfreyseed",
		["Base.WildGarlic2"] = "GMH.WildGarlicseed",
		["Base.Ginseng"] = "GMH.Ginsengseed",
		["Base.LemonGrass"] = "GMH.LemonGrassseed",
		["Base.CommonMallow"] = "GMH.CommonMallowseed",
	};
...
forageDefs = {
	...
	CommonMallow = {
		...
		months = { 3, 4, 5, 6, 7, 8, 9, 10, 11 },
		spawnFuncs = { doWildFoodSpawn, doWildCropSpawn, doRandomAgeSpawn },
		altWorldTexture = worldSprites.vines,
	},
	LemonGrass = {
