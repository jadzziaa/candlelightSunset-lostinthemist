...
--~ 	print(red);
	...
	if instanceof(item, "HandWeapon") then
		...
		if canon and canon:getScriptItem():getConditionMax() > 0 then
	...
	elseif instanceof(item, "WeaponPart") and item:getScriptItem():getConditionMax() > 0 then
		local text = getText("IGUI_invpanel_Condition") .. ":"
