...
ISBarricadesUP = ISBuildingObject:derive("ISBarricadesUP");

--************************************************************************--
--** ISBarricadesUP:new
--**
--************************************************************************--
function ISBarricadesUP:create(x, y, z, north, sprite)
...
function ISBarricadesUP:removeFromGround(square)
...
function ISBarricadesUP:new(name, sprite, northSprite)
	local o = {};
	setmetatable(o, self);
	self.__index = self;
	o:init();
...
function ISBarricadesUP:getHealth()
	return 2000 + buildUtil.getWoodHealth(self);
end

function ISBarricadesUP:isValid(square)
...
function ISBarricadesUP:render(x, y, z, square)
