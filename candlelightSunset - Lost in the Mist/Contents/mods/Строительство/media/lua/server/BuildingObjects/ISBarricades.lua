...
ISBarricades = ISBuildingObject:derive("ISBarricades");

--************************************************************************--
--** ISBarricades:new
--**
--************************************************************************--
function ISBarricades:create(x, y, z, north, sprite)
...
function ISBarricades:removeFromGround(square)
...
function ISBarricades:new(name, sprite, northSprite)
	local o = {};
	setmetatable(o, self);
	self.__index = self;
	o:init();
...
function ISBarricades:getHealth()
	return 1000 + buildUtil.getWoodHealth(self);
end

function ISBarricades:isValid(square)
...
function ISBarricades:render(x, y, z, square)
