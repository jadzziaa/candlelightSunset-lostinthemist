...
--            ISBuildMenu.buildLightMenu(subMenu, lightOption, player);
			...
			--ДЕКОРАЦИИ ПРОДВИНУТОЕ СТРОИТЕЛЬСТВО
			local DecorOption = subMenu:addOption(getText("Barricades"), worldobjects, nil);
...
--сабменю баррикады
local DecorationOption = subMenu:addOption(getText("BarricadesDown"), worldobjects, nil);
local subMenuDecoration = subMenu:getNew(subMenu);
context:addSubMenu(DecorationOption, subMenuDecoration);
--сабменю баррикады высокие
local DecorationOption = subMenu:addOption(getText("BarricadesUp"), worldobjects, nil);
local subMenuDecoration2 = subMenu:getNew(subMenu);
context:addSubMenu(DecorationOption, subMenuDecoration2);

-- Баррикада 1 УРОВЕНЬ
local BarricadesOption = subMenuDecoration:addOption(getText("Barricades1"), worldobjects, ISBuildMenu.onBarricadesOption, square, player);
local tooltip = ISBuildMenu.canBuild(12,12,0,0,0,1, BarricadesOption, player);
tooltip:setName(getText("ContextMenu_Barricades"));
tooltip.description = getText("Tooltip_Barricades") .. tooltip.description;
tooltip:setTexture("DylansJunkstacks01_27");
ISBuildMenu.requireHammer(BarricadesOption)


-- Баррикада2 1 УРОВЕНЬ
local Barricades2Option = subMenuDecoration:addOption(getText("Barricades2"), worldobjects, ISBuildMenu.onBarricades2Option, square, player);
local tooltip = ISBuildMenu.canBuild(12,12,0,0,0,1, Barricades2Option, player);
tooltip:setName(getText("ContextMenu_Barricades2"));
tooltip.description = getText("Tooltip_Barricades2") .. tooltip.description;
tooltip:setTexture("DylansJunkstacks01_24");
ISBuildMenu.requireHammer(Barricades2Option)


-- Баррикада3 1 УРОВЕНЬ
local Barricades3Option = subMenuDecoration:addOption(getText("Barricades3"), worldobjects, ISBuildMenu.onBarricades3Option, square, player);
local tooltip = ISBuildMenu.canBuild(12,12,0,0,0,1, Barricades3Option, player);
tooltip:setName(getText("ContextMenu_Barricades3"));
tooltip.description = getText("Tooltip_Barricades3") .. tooltip.description;
tooltip:setTexture("DylansJunkstacks01_45");
ISBuildMenu.requireHammer(Barricades3Option)


-- Баррикада4 1 УРОВЕНЬ
local Barricades4Option = subMenuDecoration:addOption(getText("Barricades4"), worldobjects, ISBuildMenu.onBarricades4Option, square, player);
local tooltip = ISBuildMenu.canBuild(12,12,0,0,0,1, Barricades4Option, player);
tooltip:setName(getText("ContextMenu_Barricades4"));
tooltip.description = getText("Tooltip_Barricades4") .. tooltip.description;
tooltip:setTexture("DylansJunkstacks01_22");
ISBuildMenu.requireHammer(Barricades4Option)


-- Баррикада5 1 УРОВЕНЬ
local Barricades5Option = subMenuDecoration:addOption(getText("Barricades5"), worldobjects, ISBuildMenu.onBarricades5Option, square, player);
local tooltip = ISBuildMenu.canBuild(12,12,0,0,0,1, Barricades5Option, player);
tooltip:setName(getText("ContextMenu_Barricades5"));
tooltip.description = getText("Tooltip_Barricades5") .. tooltip.description;
tooltip:setTexture("DylansJunkstacks01_1");
ISBuildMenu.requireHammer(Barricades5Option)


-- Баррикада6 1 УРОВЕНЬ
local Barricades6Option = subMenuDecoration:addOption(getText("Barricades6"), worldobjects, ISBuildMenu.onBarricades6Option, square, player);
local tooltip = ISBuildMenu.canBuild(12,12,0,0,0,1, Barricades6Option, player);
tooltip:setName(getText("ContextMenu_Barricades6"));
tooltip.description = getText("Tooltip_Barricades6") .. tooltip.description;
tooltip:setTexture("DylansJunkstacks01_8");
ISBuildMenu.requireHammer(Barricades6Option)


-- Баррикада7 1 уровень
local Barricades7Option = subMenuDecoration:addOption(getText("Barricades7"), worldobjects, ISBuildMenu.onBarricades7Option, square, player);
local tooltip = ISBuildMenu.canBuild(12,12,0,0,0,1, Barricades7Option, player);
tooltip:setName(getText("ContextMenu_Barricades7"));
tooltip.description = getText("Tooltip_Barricades7") .. tooltip.description;
tooltip:setTexture("DylansJunkstacks01_15");
ISBuildMenu.requireHammer(Barricades7Option)


-- Баррикада8 1 уровень
local Barricades8Option = subMenuDecoration:addOption(getText("Barricades8"), worldobjects, ISBuildMenu.onBarricades8Option, square, player);
local tooltip = ISBuildMenu.canBuild(12,12,0,0,0,1, Barricades8Option, player);
tooltip:setName(getText("ContextMenu_Barricades8"));
tooltip.description = getText("Tooltip_Barricades8") .. tooltip.description;
tooltip:setTexture("DylansJunkstacks01_12");
ISBuildMenu.requireHammer(Barricades8Option)


-- Баррикада высокая 1 уровень
local BarricadesUpOption = subMenuDecoration2:addOption(getText("BarricadesUp1"), worldobjects, ISBuildMenu.onBarricadesUpOption, square, player);
local tooltip = ISBuildMenu.canBuild(20,20,0,0,0,1, BarricadesUpOption, player);
tooltip:setName(getText("ContextMenu_BarricadesUp"));
tooltip.description = getText("Tooltip_BarricadesUp") .. tooltip.description;
tooltip:setTexture("DylansJunkstacks01_25");
ISBuildMenu.requireHammer(BarricadesUpOption)


--Баррикада высокая2 1 уровень
local BarricadesUp2Option = subMenuDecoration2:addOption(getText("BarricadesUp2"), worldobjects, ISBuildMenu.onBarricadesUp2Option, square, player);
local tooltip = ISBuildMenu.canBuild(20,20,0,0,0,1, BarricadesUp2Option, player);
tooltip:setName(getText("ContextMenu_BarricadesUp2"));
tooltip.description = getText("Tooltip_BarricadesUp2") .. tooltip.description;
tooltip:setTexture("DylansJunkstacks01_42");
ISBuildMenu.requireHammer(BarricadesUp2Option)


--Баррикада высокая3 1 уровень
local BarricadesUp3Option = subMenuDecoration2:addOption(getText("BarricadesUp3"), worldobjects, ISBuildMenu.onBarricadesUp3Option, square, player);
local tooltip = ISBuildMenu.canBuild(20,20,0,0,0,1, BarricadesUp3Option, player);
tooltip:setName(getText("ContextMenu_BarricadesUp3"));
tooltip.description = getText("Tooltip_BarricadesUp3") .. tooltip.description;
tooltip:setTexture("DylansJunkstacks01_7");
ISBuildMenu.requireHammer(BarricadesUp3Option)


--Баррикада высокая4 1 уровень
local BarricadesUp4Option = subMenuDecoration2:addOption(getText("BarricadesUp4"), worldobjects, ISBuildMenu.onBarricadesUp4Option, square, player);
local tooltip = ISBuildMenu.canBuild(20,20,0,0,0,1, BarricadesUp4Option, player);
tooltip:setName(getText("ContextMenu_BarricadesUp4"));
tooltip.description = getText("Tooltip_BarricadesUp4") .. tooltip.description;
tooltip:setTexture("DylansJunkstacks01_63");
ISBuildMenu.requireHammer(BarricadesUp4Option)
...
ISBuildMenu.onBarricadesOption = function(worldobjects, square, player)
	local furniture = ISBarricades:new("Barricades", "DylansJunkstacks01_27", "DylansJunkstacks01_31");
	furniture.modData["need:Base.Plank"] = "12";
	furniture.modData["need:Base.Nails"] = "12";
	-- our chair have 4 tiles (north, east, south and west)
	-- then we define our east and south sprite
	furniture:setEastSprite("DylansJunkstacks01_52");
	furniture:setSouthSprite("DylansJunkstacks01_54");
...
ISBuildMenu.onBarricades2Option = function(worldobjects, square, player)
	local furniture = ISBarricades:new("Barricades2", "DylansJunkstacks01_24", "DylansJunkstacks01_23");
	furniture.modData["need:Base.Plank"] = "12";
	furniture.modData["need:Base.Nails"] = "12";
	furniture:setEastSprite("DylansJunkstacks01_34");
	furniture:setSouthSprite("DylansJunkstacks01_30");
	furniture.blockAllTheSquare = true;
		furniture.player = player;
		furniture.maxTime = 250;
		getCell():setDrag(furniture, player);
...
ISBuildMenu.onBarricades3Option = function(worldobjects, square, player)
	local furniture = ISBarricades:new("Barricades3", "DylansJunkstacks01_45", "DylansJunkstacks01_13");
	furniture.modData["need:Base.Plank"] = "12";
	furniture.modData["need:Base.Nails"] = "12";
	furniture:setEastSprite("DylansJunkstacks01_21");
	furniture:setSouthSprite("DylansJunkstacks01_20");
		furniture.player = player;
		furniture.maxTime = 250;
		getCell():setDrag(furniture, player);
end

ISBuildMenu.onBarricades4Option = function(worldobjects, square, player)
	local furniture = ISBarricades:new("Barricades4", "DylansJunkstacks01_22", "DylansJunkstacks01_44");
	furniture.modData["need:Base.Plank"] = "12";
	furniture.modData["need:Base.Nails"] = "12";
	furniture:setEastSprite("DylansJunkstacks01_11");
	furniture:setSouthSprite("DylansJunkstacks01_17");
		furniture.player = player;
		furniture.maxTime = 250;
		getCell():setDrag(furniture, player);
end
...
ISBuildMenu.onBarricades5Option = function(worldobjects, square, player)
	local furniture = ISBarricades:new("Barricades5", "DylansJunkstacks01_1", "DylansJunkstacks01_39");
	furniture.modData["need:Base.Plank"] = "12";
	furniture.modData["need:Base.Nails"] = "12";
	furniture:setEastSprite("DylansJunkstacks01_28");
	furniture:setSouthSprite("DylansJunkstacks01_59");
		furniture.player = player;
		furniture.maxTime = 250;
		getCell():setDrag(furniture, player);
end

ISBuildMenu.onBarricades6Option = function(worldobjects, square, player)
	local furniture = ISBarricades:new("Barricades6", "DylansJunkstacks01_8", "DylansJunkstacks01_33");
	furniture.modData["need:Base.Plank"] = "12";
	furniture.modData["need:Base.Nails"] = "12";
	furniture:setEastSprite("DylansJunkstacks01_35");
	furniture:setSouthSprite("DylansJunkstacks01_61");
		furniture.player = player;
		furniture.maxTime = 250;
		getCell():setDrag(furniture, player);
end

ISBuildMenu.onBarricades7Option = function(worldobjects, square, player)
	local furniture = ISBarricades:new("Barricades7", "DylansJunkstacks01_15", "DylansJunkstacks01_41");
	furniture.modData["need:Base.Plank"] = "12";
	furniture.modData["need:Base.Nails"] = "12";
	furniture:setEastSprite("DylansJunkstacks01_9");
	furniture:setSouthSprite("DylansJunkstacks01_18");
		furniture.player = player;
		furniture.maxTime = 250;
		getCell():setDrag(furniture, player);
end

ISBuildMenu.onBarricades8Option = function(worldobjects, square, player)
	local furniture = ISBarricades:new("Barricades8", "DylansJunkstacks01_12", "DylansJunkstacks01_10");
	furniture.modData["need:Base.Plank"] = "12";
	furniture.modData["need:Base.Nails"] = "12";
	furniture:setEastSprite("DylansJunkstacks01_51");
	furniture:setSouthSprite("DylansJunkstacks01_56");
		furniture.player = player;
		furniture.maxTime = 250;
		getCell():setDrag(furniture, player);
end

ISBuildMenu.onBarricadesUpOption = function(worldobjects, square, player)
	local furniture = ISBarricadesUP:new("BarricadesUp", "DylansJunkstacks01_25", "DylansJunkstacks01_43");
	furniture.modData["need:Base.Plank"] = "20";
	furniture.modData["need:Base.Nails"] = "20";
	furniture:setEastSprite("DylansJunkstacks01_2");
	furniture:setSouthSprite("DylansJunkstacks01_26");
		furniture.player = player;
		furniture.maxTime = 250;
		getCell():setDrag(furniture, player);
end

ISBuildMenu.onBarricadesUp2Option = function(worldobjects, square, player)
	local furniture = ISBarricadesUP:new("BarricadesUp2", "DylansJunkstacks01_42", "DylansJunkstacks01_32");
	furniture.modData["need:Base.Plank"] = "20";
	furniture.modData["need:Base.Nails"] = "20";
	furniture:setEastSprite("DylansJunkstacks01_36");
	furniture:setSouthSprite("DylansJunkstacks01_19");
		furniture.player = player;
		furniture.maxTime = 250;
		getCell():setDrag(furniture, player);
end

ISBuildMenu.onBarricadesUp3Option = function(worldobjects, square, player)
	local furniture = ISBarricadesUP:new("BarricadesUp3", "DylansJunkstacks01_6", "DylansJunkstacks01_0");
	furniture.modData["need:Base.Plank"] = "20";
	furniture.modData["need:Base.Nails"] = "20";
	furniture:setEastSprite("DylansJunkstacks01_7");
	furniture:setSouthSprite("DylansJunkstacks01_5");
		furniture.player = player;
		furniture.maxTime = 250;
		getCell():setDrag(furniture, player);
end

ISBuildMenu.onBarricadesUp4Option = function(worldobjects, square, player)
	local furniture = ISBarricadesUP:new("BarricadesUp4", "DylansJunkstacks01_63", "DylansJunkstacks01_47");
	furniture.modData["need:Base.Plank"] = "20";
	furniture.modData["need:Base.Nails"] = "20";
	furniture:setEastSprite("DylansJunkstacks01_48");
	furniture:setSouthSprite("DylansJunkstacks01_58");
		furniture.player = player;
		furniture.maxTime = 250;
		getCell():setDrag(furniture, player);
end
