...
GameAPI.Add("pz_b41", "Project Zomboid", "2013", "The Indie Stone", "Survival", "pz")
GameAPI.Add("metal_gear", "Metal Gear", "1987", "Konami", "Stealth Adventure", "metal_gear")
GameAPI.Add("metal_gear_2", "Metal Gear 2: Solid Snake", "1990", "Konami", "Stealth Adventure", "metal_gear_2")
GameAPI.Add("snake_revenge", "Snake's Revenge", "1990", "Konami", "Stealth Adventure", "snake_revenge")
...
GameAPI.Add("contra", "Contra", "1987", "Konami", "Sidescrolling Shooter", "Contra")
...
GameAPI.Add("star_wars_x_wing", "Star Wars: X-Wing", "1993", "Lucasarts", "Space-sim", "star_wars_x_wing")
