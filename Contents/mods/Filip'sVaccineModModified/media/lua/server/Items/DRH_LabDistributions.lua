...
table.insert(ProceduralDistributions.list["ShelfGeneric"].items, 0.1);
table.insert(ProceduralDistributions.list["ShelfGeneric"].items, "LabBooks.BkVirologyCourses3");
table.insert(ProceduralDistributions.list["ShelfGeneric"].items, 0.1);
...
table.insert(ProceduralDistributions.list["BookstoreBooks"].items, 1);
table.insert(ProceduralDistributions.list["BookstoreBooks"].items, "LabBooks.BkVirologyCourses3");
table.insert(ProceduralDistributions.list["BookstoreBooks"].items, 1);
...
table.insert(ProceduralDistributions.list["PostOfficeMagazines"].items, 0.4);
table.insert(ProceduralDistributions.list["PostOfficeMagazines"].items, "LabBooks.BkVirologyCourses3");
table.insert(ProceduralDistributions.list["PostOfficeMagazines"].items, 0.4);
...
table.insert(ProceduralDistributions.list["ToolStoreMisc"].items, "LabItems.ChFormaldehydeCan");
table.insert(ProceduralDistributions.list["ToolStoreMisc"].items, 5);
table.insert(ProceduralDistributions.list["GarageTools"].items, "LabItems.ChFormaldehydeCan");
table.insert(ProceduralDistributions.list["GarageTools"].items, 5);
table.insert(ProceduralDistributions.list["MechanicShelfTools"].items, "LabItems.ChFormaldehydeCan");
table.insert(ProceduralDistributions.list["MechanicShelfTools"].items, 10);
table.insert(ProceduralDistributions.list["StoreShelfMedical"].items, "LabItems.ChFormaldehydeCan");
table.insert(ProceduralDistributions.list["StoreShelfMedical"].items, 10);
table.insert(ProceduralDistributions.list["JanitorChemicals"].items, "LabItems.ChFormaldehydeCan");
table.insert(ProceduralDistributions.list["JanitorChemicals"].items, 10);
table.insert(ProceduralDistributions.list["JanitorChemicals"].items, "LabItems.ChFormaldehydeCan");
table.insert(ProceduralDistributions.list["JanitorChemicals"].items, 10);
table.insert(ProceduralDistributions.list["JanitorCleaning"].items, "LabItems.ChFormaldehydeCan");
table.insert(ProceduralDistributions.list["JanitorCleaning"].items, 10);
table.insert(ProceduralDistributions.list["JanitorMisc"].items, "LabItems.ChFormaldehydeCan");
table.insert(ProceduralDistributions.list["JanitorMisc"].items, 8);
table.insert(ProceduralDistributions.list["CrateMechanics"].items, "LabItems.ChFormaldehydeCan");
table.insert(ProceduralDistributions.list["CrateMechanics"].items, 8);
...
-- Medical Facilities
table.insert(ProceduralDistributions.list["MedicalClinicDrugs"].items, "LabItems.AlcoholWipesPack");
table.insert(ProceduralDistributions.list["MedicalClinicDrugs"].items, 6);
table.insert(ProceduralDistributions.list["MedicalStorageDrugs"].items, "LabItems.AlcoholWipesPack");
table.insert(ProceduralDistributions.list["MedicalStorageDrugs"].items, 13);

-- Procedural SuburbsDistributions
table.insert(ProceduralDistributions.list["StoreShelfMedical"].items, "LabItems.AlcoholWipesPack");
table.insert(ProceduralDistributions.list["StoreShelfMedical"].items, 13);

-- Vehicles
table.insert(VehicleDistributions.DoctorTruckBed.items, "LabItems.AlcoholWipesPack");
table.insert(VehicleDistributions.DoctorTruckBed.items, 20);
...
table.insert(SuburbsDistributions["all"]["crate"].items, "LabItems.ChFormaldehydeCan");
table.insert(SuburbsDistributions["all"]["crate"].items, 4);
