...
local distributionTable = {
	...
	hospitalstuff = {
        metal_shelves = {
            ...
            procList = {
                ...
                {name="MedicalStorageTools", min=0, max=99, weightChance=60},
                {name="MedicalStorageOutfit", min=0, max=99, weightChance=30},
            }
        },
		crate = {
            procedural = true,
	...
	mininglocker = {
        locker = {
            procedural = true,
            procList = {
                {name="AllKindsOFStuff", min=0, max=99, weightChance=100},
            },
        },
    },
	...
	spoonhermit = {
        ...
        fridge = {
            ...
            procedural = true,
            procList = {
				{name="Crate_FoodMill1", min=0, max=99, weightChance=5},
				{name="Crate_FoodMill2", min=0, max=99, weightChance=5},
            }
        },
        freezer = {
            rolls = 1,
        ...
        counter = {
            ...
            procedural = true,
            procList = {
                {name="Crate_FoodMill1", min=1, max=1, weightChance=100},
                {name="Crate_FoodMill2", min=1, max=1, weightChance=100},
                {name="StoreCounterCleaning", min=0, max=99, weightChance=20},
                {name="StoreKitchenDishes", min=0, max=1, weightChance=20},
                {name="BarCounterLiquor", min=1, max=1, weightChance=20},
                {name="StoreKitchenPots", min=0, max=1, weightChance=100},
				{name="AllKindsOFStuff", min=0, max=99, weightChance=20},
            }
        },
        shelves = {
            rolls = 4,
            procedural = true,
            procList = {
                {name="CampingStoreClothes", min=0, max=8, weightChance=60},
                {name="CampingStoreLegwear", min=0, max=2, weightChance=60},
                {name="CampingStoreBackpacks", min=0, max=2, weightChance=40},
                {name="CampingStoreGear", min=0, max=10, weightChance=100},
                {name="FishingStoreGear", min=0, max=6, weightChance=20},
				{name="AllKindsOFStuff", min=0, max=99, weightChance=20},
            }
        },
		crate = {
	...
	miningcrate = {
        crate = {
            procedural = true,
            procList = {
                {name="MineStuff", min=0, max=99, weightChance=50},
				{name="PlumbingSupplies", min=0, max=99, weightChance=25},
				{name="ToolStoreTools", min=0, max=99, weightChance=25},
				{name="Crate_FoodMill1", min=0, max=99, weightChance=5},
				{name="Crate_FoodMill2", min=0, max=99, weightChance=5},
            },
        },
		locker = {
            procedural = true,
            procList = {
                {name="LoggingStuff", min=0, max=99, weightChance=50},
				{name="PlumbingSupplies", min=0, max=99, weightChance=25},
				{name="ToolStoreTools", min=0, max=99, weightChance=25},
				{name="Crate_FoodMill1", min=0, max=99, weightChance=5},
				{name="Crate_FoodMill2", min=0, max=99, weightChance=5},
				{name="AllKindsOFStuff", min=0, max=99, weightChance=5},
            },
        },
    },
	...
	sawmillitems = {
        crate = {
            procedural = true,
            procList = {
                {name="WoodyWoody", min=0, max=99, weightChance=75},
				{name="LoggingStuff", min=0, max=99, weightChance=5},
				{name="PlumbingSupplies", min=0, max=99, weightChance=5},
	...
	foodmill = {		
		crate = {
            procedural = true,
            procList = {
                {name="Crate_FoodMill1", min=0, max=99, weightChance=80},
				{name="Crate_FoodMill2", min=0, max=99, weightChance=20},
				{name="CrateCereal", min=0, max=99, weightChance=10},
            },
        },
    },
	...
	breweryrural = {
        crate = {
            procedural = true,
            procList = {
                {name="BreweyRuralReady", min=0, max=99, weightChance=100},
                {name="BreweryEmptyBottles", min=0, max=99, weightChance=40},
            }
        },
        metal_shelves = {
            procedural = true,
            procList = {
                {name="BreweyRuralRaw", min=0, max=99, weightChance=100},
                {name="BreweyRuralReady", min=0, max=99, weightChance=40},
                {name="BreweryEmptyBottles", min=0, max=99, weightChance=20},
            }
        },
    },
