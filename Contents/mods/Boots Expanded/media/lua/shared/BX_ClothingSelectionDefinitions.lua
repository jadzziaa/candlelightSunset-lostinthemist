...
--		},
		...
		Shoes = {
			items = {"Base.Shoes_WorkBoots", "Base.Shoes_ConverseSnickers", "Base.Shoes_Hitops", "Base.Shoes_Sneakers", "Shoes_BlackBoots",},
		},
	},
...
--		},
		...
		Shoes = {
			items = {"Base.Shoes_WorkBoots", "Base.Shoes_ConverseSnickers", "Base.Shoes_Hitops", "Base.Shoes_Hitops", "Base.Shoes_Sneakers"},
		},
	}
}
...
--		},
		...
		Shoes = {
			items = {"Base.Shoes_WorkBoots", "Base.Shoes_ArmyBoots"};
		},
	},
}
...
ClothingSelectionDefinitions.veteran = {
	Female = {
		...
		Shoes = {
			items = {"Base.Shoes_ArmyBoots", "Base.Shoes_ArmyBootsDesert", "Base.Shoes_JungleBoots"},
		},
	},
}
