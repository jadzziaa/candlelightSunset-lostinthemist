...
for k, v in pairs(CContainers.BackpacksPumpPury) do
    ...
    elseif SandboxVars.CustomizableBackpacks.Capacity == 15 then  -- Capacity = 25
...
for k, v in pairs(CContainers.BagsPumpPury) do
    ...
    elseif SandboxVars.CustomizableBags.Capacity == 15 then  -- Capacity = 25
...
for k, v in pairs(CContainers.FannyPacksPumpPury) do
    ...
    elseif SandboxVars.CustomizableFannyPacks.Capacity == 15 then  -- Capacity = 25
