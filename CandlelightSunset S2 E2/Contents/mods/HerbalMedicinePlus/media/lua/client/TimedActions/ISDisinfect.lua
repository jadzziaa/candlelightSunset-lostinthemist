...
function ISDisinfect:perform()
    ...
    if(instanceof(self.alcohol, "Food")) then
        self.alcohol:setThirstChange(self.alcohol:getThirstChange() + 0.02);
        if(self.alcohol:getBaseHunger() < 0) then
            self.alcohol:setHungChange(self.alcohol:getHungChange() + 0.02);
        end

        if self.alcohol:getThirstChange() > -0.002 or self.alcohol:getHungerChange() > -0.002 then
            self.alcohol:Use();
        end
