...
LGRLZ.initTable = function()
	if LZFunc then
		...
		LZFunc.LootZetaAddItemTable("Waiter_PileOCrepe","PieQuince",20,false,modname);
		...
		LZFunc.LootZetaAddItemTable("Chef","PieQuince",10,false,modname);
		...
		LZFunc.LootZetaAddItemTable("Waiter_Spiffo","PieQuince",15,false,modname);
