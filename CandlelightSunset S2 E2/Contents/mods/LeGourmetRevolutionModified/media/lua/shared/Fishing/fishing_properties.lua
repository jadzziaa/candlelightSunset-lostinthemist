...
--table.insert(trout.lure, "Maggots2");
...
--table.insert(panfish.lure, "Maggots2");
...
--table.insert(perch.lure, "Maggots2");
...
--table.insert(walleye.lure, "Maggots2");
...
walleye.little.minScale = 0.5;
walleye.little.maxScale = 0.6;
walleye.medium.minSize = 25;
walleye.medium.maxSize = 45;
walleye.medium.minScale = 0.6;
walleye.medium.maxScale = 0.8;
walleye.big.minSize = 45;
walleye.big.maxSize = 55;
walleye.big.minScale = 0.8;
walleye.big.maxScale = 0.9;
walleye.trophy.minSize = 55;
walleye.trophy.maxSize = 65;
walleye.trophy.minScale = 0.9;
walleye.trophy.maxScale = 1.0;
...
--table.insert(socks.lure, "Maggots2");
...
--table.insert(shoes.lure, "Maggots2");
...
Fishing.OnCreateFish = function(_item)
	...
	if not customscale then
		...
		--self.character:Say("Mult " .. tostring(Mult) .. ", " .. "NewScale " .. tostring(NewScale))
		item:setWorldScale(NewScale);
	end
