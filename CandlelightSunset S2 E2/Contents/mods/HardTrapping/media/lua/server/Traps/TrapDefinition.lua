...
crateTrap.trapStrength = 50;
crateTrap.destroyItem = { "Base.UnusableWood", "Base.Plank", "Base.Plank", "Base.WoodenStick", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails" };
...
trapBox.trapStrength = 75;
trapBox.destroyItem = { "Base.UnusableWood", "Base.Wire", "Base.Plank", "Base.Plank", "Base.WoodenStick", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails", "Base.Nails" };
...
stickTrap.trapStrength = 5;
stickTrap.destroyItem = { "Base.UnusableWood", "Base.Twine", "Base.Twine" };
...
mouseTrap.destroyItem = "Base.UnusableWood", "Base.Wire", "Base.ScrapMetal", "Base.ScrapMetal";
